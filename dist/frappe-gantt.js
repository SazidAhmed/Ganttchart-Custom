...
class Gantt {
    ...
    update_view_scale(view_mode) {
        ...
        if (view_mode === VIEW_MODE.HOUR) {
            ...
            this.options.step = 9 * 5; // Assuming a 5-day workweek
            this.options.column_width = 140;
        } else if (view_mode === VIEW_MODE.MONTH) {
            this.options.step = 9 * 22; // Assuming an average of 22 workdays in a month
            this.options.column_width = 120;
        } else if (view_mode === VIEW_MODE.YEAR) {
            this.options.step = 9 * 22 * 12; // Assuming 22 workdays per month for 12 months
            this.options.column_width = 120;
        }
    }
